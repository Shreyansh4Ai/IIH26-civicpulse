  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      ...
      drawer: isDesktop
          ? null
          : const Drawer(
              child: CivicSideNav(variant: 'officer', activeIndex: 2), // 2 is Analytics
            ),
      body: Row(
        crossAxisAlignment: CrossAxisAlignment.start,
        children: [
          if (isDesktop) const CivicSideNav(variant: 'officer', activeIndex: 2),
          Expanded(
            child: Column(
              children: [
                        ...
                        children: [
                          ...
                          Center(
                            child: Padding(
                              ...
                              child: Text(
                                'Analytics Dashboard & Charts (Placeholder)',
